...
root_directory = 'C:/Users/Elias/Documents/GitHub/app_inventor_analysis/modulo_doze'

# Diretório que ficará com as submissões inválidas ( O script cuidará de sua criação )
destination_directory = 'C:/Users/Elias/Documents/GitHub/app_inventor_analysis/modulo_doze_not_accepted'
...
for dirpath, dirnames, _ in os.walk(root_directory):
    for dirname in dirnames:
        ...
        if any(filename.endswith('.aia') for filename in os.listdir(folder_path)):
            ...
            # Renomear a pasta para "<matricula_aluno>_contem_aia"
            change_directory_name(folder_path, "_contem_aia")
            ...
            if any(filename.endswith('.zip') for filename in os.listdir(folder_path)):
                ...
                # Renomear a pasta para "<matricula_aluno>nao_contem_aia"
                change_directory_name(folder_path, "nao_contem_aia")
...
for item in os.listdir(root_directory):
    ...
    if os.path.isdir(item_path):
        ...
        # Checar se o nome da pasta contém "nao_contem_aia"
        if "nao_contem_aia" in item:
